...
class _UploadFilePageState extends State<UploadFilePage> {
  ...
  void abrirPdf() {
    if (fileBytes == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Selecione um PDF primeiro")),
      );
      return;
    }
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PdfViewerPage(pdfBytes: fileBytes!),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Selecionar PDF')),
      body: Padding(
